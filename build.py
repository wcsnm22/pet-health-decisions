# ILANG
# TYPE:module ROLE:builder PROJECT:pet-health-decisions
...
OFFICIAL_HOSTS = {
    "vetster.com", "www.vetster.com",
    "1800petmeds.com", "www.1800petmeds.com",
...
OG_SITE_NAME = "Pet Health Decisions"

# 首页 title/H1（吃“在线兽医 / 宠物药房 / 保健品 / DNA 检测”一族搜索意图）
HOME_TITLE = (
    "Pet Health: Online Vet, Medication, Supplements and Dog DNA Tests - "
    "Facts from Vetster, 1-800-PetMeds, Cosequin and Embark"
)
...
def build() -> None:
    ...
    for b in brands:
        title = (
            f'{b["name"]}: Review, Cost, Quote and Discount Facts for Pet Parents '
            f'(Sources Inside)'
        )
        description = (
        ...
        html = render(brand_tpl, {
            ...
            "nav": f'<a href="/">Home</a> · {nav}',
            "name": b["name"],
            "h1": f'{b["name"]}: review, cost, quote and discount facts for pet parents',
